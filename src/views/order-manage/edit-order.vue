        ...
        >
          ...
          >
            ...
            <el-col style="margin-left: 8px;">预计取件时间：
              {{ orderDetailShow.taskPickup.estimatedEndTime }}
            </el-col>
            <el-col style="margin-left: 8px;">取件完成时间：
              {{ orderDetailShow.taskPickup.estimatedStartTime }}
            </el-col>
            <el-col />
          </el-row>
        </el-collapse-item>
        ...
        >
          ...
          >
            <el-col style="margin-left: 0px;">预计取件时间：
              {{ orderDetailShow.taskDispatch.estimatedEndTime }}
            </el-col>
            <el-col style="margin-left: -155px;">取件完成时间：
              {{ orderDetailShow.taskDispatch.estimatedStartTime }}
            </el-col>
            <el-col />
          </el-row>
        </el-collapse-item>
...
<script>
import showOrderMapsDialog from './components/show-order-map.vue'
...
export default {
  ...
  methods: {
    ...
    async getList(wayId) {
      ...
      console.log(data)
      this.agencyName = this.orderDetailShow.taskDispatch.agency.name
