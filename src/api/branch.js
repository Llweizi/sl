...
// getManagerCarriages 运费管理接口
export const getManagerCarriages = () => createAPI(`/carriages`, 'GET')

// 运费管理 删除接口
export const delManagerCarriages = id => createAPI(`/carriages/${id}`, 'DELETE', id)

// 运费管理 // 新增/修改运费模板
export const postManagerCarriages = data => createAPI(`/carriages`, 'post', data)
